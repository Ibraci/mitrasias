@extends('layouts.master', ['title' => 'Create Batch'])
...
@section('content')
    ...
    @endif
    <div class="row">
        <form class="col s12" method="POST" action="{{ route('batches.store') }}">

            {{ csrf_field() }}

            <div class="row">
                <div class="col s12">
                    <h5 class="admission-details-title">Create Batch</h4>
                    <hr>
                </div>

                <div class="input-field col s6">
                    <i class="material-icons prefix">book</i>
                    <input id="batch_name" type="text" class="validate" name="batch_name">
                    <label for="batch_name">Batch Name</label>
                </div>

                <div class="input-field col s6">
                    <i class="material-icons prefix">bookmark</i>
                    <input id="batch_subject" type="text" class="validate" name="batch_subject">
                ...
                <div class="input-field col s4">
                    <i class="material-icons prefix">bookmark</i>
                    <input id="batch_number" type="text" class="validate" name="batch_number">
